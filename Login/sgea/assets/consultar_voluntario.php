                ...
                <div class="col-12 mt-5 align-items-center">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            // Determinar a coluna e a direção da ordenação
                            $order_column = "id";
                            $order_direction = "ASC";
                            ...
                            // Verifique a página atual (se não especificada, será a página 1)
                            $pagina_atual = isset($_GET['page']) ? $_GET['page'] : 1;

                            // Calcule o deslocamento para a consulta
                            $offset = ($pagina_atual - 1) * $registros_por_pagina;

                            // Consulta para recuperar voluntários da tabela "voluntarios" com ordenação e paginação
