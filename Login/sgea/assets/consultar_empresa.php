                    ...
                    <div id="sidebar-nav" class="list-group border-0 rounded-0">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item" aria-current="true">
                                <div class="dropdown">
                                    <i class="bi bi-plus"></i><a class="dropdown-toggle text-decoration-none text-black"
                                        href="#" role="button" id="cadastroDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                        Cadastrar
                                    </a>
                            ...
                            <li class="list-group-item dropdown">
                                <i class="bi bi-search"></i><a class="dropdown-toggle text-decoration-none text-black"
                                    href="#" role="button" id="consultaDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                    Consultar
                                </a>
                        ...
                        <div class="card shadow">
                            <div class="card-body text-start">
                                ...
                                <p class="card-text"><i class="bi bi-people mr-3"></i>
                                    ...
                                    $query = "SELECT COUNT(*) as total_empresas FROM empresas";
                                    $result = mysqli_query($conexao, $query);
                        ...
                        <div class="card shadow">
                            <div class="card-body text-start">
                                ...
                                <p class="card-text"><i class="bi bi-paw mr-3"></i>
                                    ...
                                    $query = "SELECT COUNT(*) as total_animais FROM animais";
                                    $result = mysqli_query($conexao, $query);
                ...
                <div class="col-12 mt-5 align-items-center">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            $consulta = "SELECT id, nome, telefone, cidade FROM voluntarios ORDER BY $order_column $order_direction LIMIT $registros_por_pagina OFFSET $offset";
                            ...
                            if ($resultado->num_rows > 0) {
                                while ($linha = $resultado->fetch_assoc()) {
                                    ...
                                    echo '<td>
                                        <a href="editar_voluntario.php?id=' . $linha["id"] . '"><i class="fas fa-edit" style="color: green;"></i></a>
                                        <a href="excluir_voluntario.php?id=' . $linha["id"] . '"><i class="fas fa-trash" style="color: red;"></i></a>
                                    </td>';
                                    echo "</tr>";
                                }
                            } else {
                                echo "<tr><td colspan='5'>Nenhum voluntário encontrado.</td></tr>";
                            }
