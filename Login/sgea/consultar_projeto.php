                ...
                <div class="col-12 mt-5 align-items-center">
                    <table class="table table-striped">
                        <thead class="table btn-primary">
                            <tr>
                                <th style="width: 10%;">ID <a href="?order=id_asc" class="sort-link">&#9650;</a> <a href="?order=id_desc" class="sort-link">&#9660;</a></th>
                                <th style="width: 30%;">Nome <a href="?order=nome_asc" class="sort-link">&#9650;</a> <a href="?order=nome_desc" class="sort-link">&#9660;</a></th>
                        ...
                        <tbody>
                            ...
                            // Consulta para recuperar os 10 primeiros voluntários da tabela "voluntarios" com ordenação
                            $consulta = "SELECT id, nome, telefone, cidade FROM voluntarios ORDER BY $order_column $order_direction LIMIT 10";
                            ...
                            if ($resultado->num_rows > 0) {
                                ...
                                echo "<tr><td colspan='4'>Nenhum voluntário encontrado.</td></tr>";
                            }
